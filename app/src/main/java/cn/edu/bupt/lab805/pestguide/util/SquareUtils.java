...
//                    .cache(new Cache(new File(cacheDir, "okhttp"), 60 * 1024 * 1024))
    ...
    private static UploadCompleteListener mListener;

    public interface UploadCompleteListener {
        void onUploadComplete(long bytesRead);
    }

    public void setOnUploadCompleteListener(UploadCompleteListener listener) {
        ...
        private Source source(Source source) {
            ...
            return new ForwardingSource(source) {
                ...
                public long read(Buffer sink, long byteCount) throws IOException {
                    ...
                    Log.i("info", "read: bytesRead " + bytesRead);
                    if (mListener != null) {
                        mListener.onUploadComplete(bytesRead);
                    }
                    return bytesRead;
                }
            };
